...
@ControllerAdvice
public class ListOfValuesExceptionHandler extends ResponseEntityExceptionHandler {

	private final Logger slf4jLogger = LoggerFactory.getLogger(this.getClass());

	@ExceptionHandler(value = ListOfValuesException.class)
	public ResponseEntity<ExceptionResult> handleBaseException(ListOfValuesException e) {
