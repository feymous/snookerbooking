...
@ControllerAdvice
public class BoardServiceExceptionHandler extends ResponseEntityExceptionHandler {

	private final Logger slf4jLogger = LoggerFactory.getLogger(this.getClass());

	@ExceptionHandler(value = BoardServiceException.class)
	public ResponseEntity<ExceptionResult> handleBaseException(BoardServiceException e) {
