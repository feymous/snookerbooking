...
public class BoardVO {
	...
	public BoardVO boardTypeId(Long boardTypeId) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.boardTypeId, boardVO.boardTypeId)
				&& Objects.equals(this.pricePerHour, boardVO.pricePerHour) && Objects.equals(this.name, boardVO.name)
	...
	@Override
	public int hashCode() {
		return Objects.hash(boardTypeId, pricePerHour, name, description, photoUrls);
	}
